...
export const ENGINE_VARIANTS = {
    ...
    mistral_small_non_grounded: {
        ...
        provider: 'mistral',
        model: process.env.MISTRAL_MODEL_BENCHMARK_COMPARE || process.env.MISTRAL_MODEL_COMPARE || 'mistral-small-latest',
    ...
    mistral_geo_default: {
        ...
        provider: 'mistral',
        model: process.env.MISTRAL_MODEL_QUERY || process.env.MISTRAL_MODEL_COMPARE || 'mistral-small-latest',
        temperature: 0.15,
        max_tokens: 2300,
        is_available: () => !!process.env.MISTRAL_API_KEY,
        web_enabled: false
