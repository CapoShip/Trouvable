...
const REPO_PATHS = {
    ...
    appRobotsRoute: path.join(/* turbopackIgnore: true */ process.cwd(), 'app', 'robots.txt', 'route.js'),
    appRobotsMetadata: path.join(/* turbopackIgnore: true */ process.cwd(), 'app', 'robots.js'),
    ...
    geoSeoInjector: path.join(/* turbopackIgnore: true */ process.cwd(), 'features', 'public', 'shared', 'GeoSeoInjector.jsx'),
    faqAccordion: path.join(/* turbopackIgnore: true */ process.cwd(), 'features', 'public', 'shared', 'FaqAccordion.jsx'),
