    ...
    return [
        {
            ...
            content: [
                ...
                '- opportunity_type must be one of: response, faq, content, differentiation.',
        ...
        },
        {
            ...
            content: [
                ...
                clusterSummary,
                '',
                'Synthesize into opportunities as JSON: { "opportunities": [{ "cluster_label": "...", "cluster_type": "...", "opportunity_type": "response|faq|content|differentiation", "headline": "...", "rationale": "...", "suggested_action": "...", "priority": "high|medium|low", "evidence_strength": "strong|moderate|weak" }] }',
            ].join('\n'),
        },
    ];
}
...
function normalize(raw, input) {
    ...
    const validTypes = ['response', 'faq', 'content', 'differentiation'];
