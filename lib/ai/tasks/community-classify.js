    ...
    return [
        {
            ...
            content: [
                ...
                '',
                'Signal family hints (tag mentions with the most relevant family when clear):',
                '- buyer_question: prospects asking how to solve a problem or choose a provider',
                '- comparison_intent: users comparing tools, providers, or approaches (vs, alternative, better)',
                '- best_tool_intent: users searching for the best tool or solution in a category',
                '- pain_point: users expressing strong frustration with existing solutions',
                '- competitor_weakness: users complaining about a competitor limitation',
                '- response_opportunity: active threads where expert response would add value',
                '- ai_mention_opportunity: discussions about AI tools where the brand could appear',
                '',
                'Rules:',
                ...
                '- When business goals or topics of interest are provided, prioritize signals relevant to those goals.',
