...
function getModel(purpose = 'audit') {
    if (purpose === 'query') return process.env.MISTRAL_MODEL_QUERY || process.env.MISTRAL_MODEL_COMPARE || 'mistral-small-latest';
    return process.env.MISTRAL_MODEL_AUDIT || process.env.MISTRAL_MODEL_COMPARE || 'mistral-small-latest';
}
