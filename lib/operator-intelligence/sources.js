    ...
    return {
        ...
        emptyState: {
            noRuns: {
                ...
                description: 'Lancez d abord les prompts suivis. La couverture citation est calculee uniquement sur les executions observees.',
            },
            noObservedCitations: {
                title: 'Aucune citation observee',
                description: 'Des executions existent, mais aucune source explicite n a ete capturee pour le moment.',
            },
        },
    };
}
