    ...
    return {
        ...
        emptyState: {
            noRuns: {
                ...
                description: 'Lancez d abord les prompts suivis. La visibilite concurrentielle est basee uniquement sur les exécutions observées.',
            },
            noCompetitors: {
                title: 'Aucun concurrent observe',
                description: 'Des exécutions existent, mais aucun concurrent fiable n a ete detecte.',
            },
        },
    };
}
