        ...
        emptyState: {
            ...
            noCompetitors: {
                ...
                description: genericNonTargetMentions > 0
                    ? `${genericNonTargetMentions} mention(s) génériques détectée(s), mais aucun concurrent confirmé. Ajoutez des concurrents connus dans le profil pour améliorer la détection.`
                    : 'Aucun concurrent détecté dans les exécutions. Ajoutez des concurrents connus dans le profil client.',
            },
        },
    };
}
