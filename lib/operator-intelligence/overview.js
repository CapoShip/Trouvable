...
export async function getOverviewSlice(clientId) {
    ...
    return {
        ...
        kpis: {
            ...
            competitorMentionsCount: competitors.summary.competitorMentions,
            genericMentionsCount: competitors.summary.genericNonTargetMentions,
            openOpportunitiesCount: opportunities.summary.open,
            visibilityProxyPercent: metrics?.visibilityProxyPercent ?? null,
            visibilityProxyReliability: metrics?.visibilityProxyReliability ?? null,
        },
        visibility: {
