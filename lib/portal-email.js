...
export async function sendPortalInvitationEmail({ contactEmail, clientName }) {
    ...
    const { error } = await resend.emails.send({
        from: fromEmail,
        to: [contactEmail],
        subject: `Votre espace Trouvable est prêt — ${displayName}`,
        html: `
            <!DOCTYPE html>
            <html>
            <head>
                ...
                <div style="max-width: 600px; margin: 0 auto; padding: 40px 16px;">
                    ...
                    <div style="background-color: #111113; padding: 44px 36px 40px 36px; border-left: 1px solid #27272a; border-right: 1px solid #27272a;">
                        ...
                        <p style="color: #a1a1aa; font-size: 14px; line-height: 1.6; margin: 0 0 28px 0;">
                            Votre espace client Trouvable est prêt. Voici ce que vous y trouverez :
                        </p>
                        ...
                        <table role="presentation" style="width: 100%; border-collapse: collapse; margin: 0 0 28px 0;">
                            <tr>
                                <td style="padding: 12px 16px; background-color: #1a1a1e; border-radius: 10px; border: 1px solid #27272a;">
                                    ...
                                    <p style="color: #71717a; font-size: 13px; margin: 0; line-height: 1.5;">Voyez comment les moteurs IA et les moteurs de recherche perçoivent votre activité.</p>
                                </td>
                            </tr>
                            <tr><td style="height: 8px;"></td></tr>
                            <tr>
                                <td style="padding: 12px 16px; background-color: #1a1a1e; border-radius: 10px; border: 1px solid #27272a;">
                                    <p style="color: #f5f5f5; font-size: 14px; font-weight: 600; margin: 0 0 4px 0;">🎯 Recommandations d'amélioration</p>
                                    <p style="color: #71717a; font-size: 13px; margin: 0; line-height: 1.5;">Des actions concrètes pour renforcer votre présence locale et vos citations IA.</p>
                                </td>
                            </tr>
                            <tr><td style="height: 8px;"></td></tr>
                            <tr>
                                <td style="padding: 12px 16px; background-color: #1a1a1e; border-radius: 10px; border: 1px solid #27272a;">
                                    <p style="color: #f5f5f5; font-size: 14px; font-weight: 600; margin: 0 0 4px 0;">📈 Rapports et évolution</p>
                                    <p style="color: #71717a; font-size: 13px; margin: 0; line-height: 1.5;">Suivez vos progrès mois après mois avec des métriques claires.</p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <div style="text-align: center; margin: 0 0 32px 0;">
                            <a href="${escapeHtml(portalUrl)}" style="display: inline-block; background: linear-gradient(135deg, #ea580c 0%, #c2410c 100%); color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 12px; font-size: 15px; font-weight: 700; letter-spacing: 0.3px; box-shadow: 0 4px 14px rgba(234,88,12,0.25);">
                        ...
                        <div style="background-color: #1a1a1e; border: 1px solid #27272a; border-radius: 12px; padding: 18px 22px; margin: 0 0 24px 0;">
                            ...
                            <ol style="color: #a1a1aa; font-size: 13px; line-height: 1.7; margin: 0; padding-left: 18px;">
                                ...
                                <li>Consultez votre tableau de bord de visibilité</li>
                                <li>Découvrez vos premières recommandations d'amélioration</li>
                            </ol>
                        </div>
