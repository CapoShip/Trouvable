...
function buildDimensionParts(scanResults, metrics, siteClassification, crawlerAccessData = null) {
    const issues = [];
    const strengths = [];
...
export function scoreAuditV2(scanResults, providedSiteClassification = null, truthContext = {}) {
    ...
    const parts = buildDimensionParts(scanResults, metrics, siteClassification, truthContext.crawlerAccessData || null);
