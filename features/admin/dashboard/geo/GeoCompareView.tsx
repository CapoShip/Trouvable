...
import { GeoBarRow, GeoEmptyPanel, GeoInlineMetric, GeoKpiCard, GeoPremiumCard } from '@/features/admin/dashboard/geo/components/GeoPremium';
import {
    applyPromptMode,
                ...
                {provider.error ? (
                    ...
                    <>
                        ...
                        <div className="rounded-lg border border-white/[0.06] bg-white/[0.015] divide-y divide-white/[0.04]">
                            ...
                            />
                            <GeoInlineMetric label="Latence" value={`${provider.latency_ms || 0} ms`} accent="default" />
                        </div>
...
export default function GeoCompareView({ linkedClientId = null, linkedClientName = null }) {
    ...
    return (
        <div className="p-4 md:p-6 space-y-5 max-w-[1650px] mx-auto">
            ...
            {!viewModel ? (
                <GeoEmptyPanel title="Aucune comparaison" description="Configurez votre prompt et source, puis lancez la comparaison pour evaluer les providers.">
                    <></>
                </GeoEmptyPanel>
            ) : (
