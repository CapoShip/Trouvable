const HOME_CANONICAL_QA = [
    ...
    },
    {
        ...
        answer: 'Parce que leurs signaux publics sont souvent incomplets ou contradictoires. Quand les données de base ne sont pas alignées, les moteurs privilégient des sources mieux structurées. Clarifier ces signaux augmente vos chances d’être cité sur des requêtes à forte intention.',
    },
    {
        question: 'Que corrige un mandat Trouvable en priorité ?',
        answer: 'Nous traitons d’abord les points qui bloquent la lecture de votre activité: cohérence des informations publiques, structuration des pages clés et clarté des services. Ensuite, nous renforçons les contenus décisionnels et les pages locales pour stabiliser votre signal Google et IA.',
    },
    {
...
export const HOME_QUICK_ANSWERS = HOME_CANONICAL_QA;
export const HOME_FAQS = HOME_CANONICAL_QA;

export const HOME_REFERENCES = [
    {
        name: 'Seer Interactive — CTR and AI Overviews',
        url: 'https://www.seerinteractive.com/news/seer-interactive-research-featured-in-inc.-analysis-of-ctr-and-ai-overviews',
    },
    {
        name: 'Yext Research — AI Citations from Brand-Managed Sources',
        url: 'https://www.businesswire.com/news/home/20251009106549/en/Yext-Research-86-of-AI-Citations-Come-from-Brand-Managed-Sources-Clarifying-How-Marketers-Can-Compete-in-the-AI-Search-Era',
    },
];
