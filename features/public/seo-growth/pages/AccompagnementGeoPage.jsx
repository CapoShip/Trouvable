...
export default function AccompagnementGeoPage({ page }) {
    ...
    return (<>
        ...
        <main>
            ...
            <section className="relative overflow-hidden border-t border-rose-400/[0.06] bg-[#0a0608] px-6 py-24 sm:px-10"><div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(244,63,94,0.06),transparent_55%)]" /><CtaSection page={page} accent="rose" headline="Un accompagnement mesuré, pas un forfait générique." icon={Handshake} /></section>
        </main>
    </>);
}
