...
export async function POST(req) {
    try {
        ...
        // 1. Honeypot check: Silently succeed (no email, no DB)
        ...
        // 6. Supabase DB Insertion (MAIN ACTION)
        ...
        // 7. Resend Email Notifications (Separate try/catch)
        ...
        try {
            ...
            if (resendApiKey && adminEmail) {
                ...
                console.warn('Resend API Key or Admin Email not configured, skipping emails.');
            }
        } catch (resendException) {
            console.error('Unhandled Resend exception:', resendException);
        }
