    ...
    return (
        <div className="flex flex-col items-end gap-1">
            ...
            <div className="flex flex-wrap justify-end gap-2">
                ...
                <Link href={`/admin/clients/${client.id}`} className="text-white font-semibold hover:text-emerald-400 text-sm">
                    Voir
                </Link>
                <Link href={`/admin/clients/${client.id}/seo-geo`} className="text-[#7b8fff] font-semibold hover:text-white text-sm">
                    Cockpit
                </Link>
