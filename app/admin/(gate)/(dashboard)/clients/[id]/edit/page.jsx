        ...
        <div className="space-y-6 max-w-5xl">
            <div className="bg-[#0f0f0f] p-6 rounded-2xl border border-white/10 flex flex-col justify-center">
                ...
                <div className="flex items-center gap-4">
                    <h1 className="text-3xl font-bold tracking-tight text-white">Éditer Profil : {client.client_name}</h1>
                    {client.is_published && (
                        <span className="bg-emerald-400/10 text-emerald-400 text-xs px-2 py-1 rounded-full font-bold">LIGNES PUBLIÉES</span>
                    )}
                </div>
                <p className="text-[#a0a0a0] mt-1">Modifiez les informations du profil GEO/SEO.</p>
            </div>
