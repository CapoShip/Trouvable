    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed top-4 left-4 z-30 flex items-center justify-center w-10 h-10 rounded-lg bg-[#0f0f0f] border border-white/10 text-white/60 hover:bg-white/[0.06] hover:text-white transition-colors lg:hidden"
            ...
            {/* Sidebar */}
            <aside
                className={`fixed inset-y-0 left-0 w-64 bg-[#0a0a0a] text-[#f0f0f0] flex flex-col z-40 border-r border-white/7 transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] ${
