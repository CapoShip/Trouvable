        ...
        <SignIn
            ...
            appearance={{
                variables: {
                    ...
                    colorText: '#fafafa',
                    /* Sous-titres, badges « dernière fois », texte secondaire */
                    colorTextSecondary: '#d4d4d8',
                    colorTextOnPrimaryBackground: '#ffffff',
                    borderRadius: '0.75rem',
                },
                elements: {
                    /* Empêche les blocs Clerk de dépasser la carte (min-width interne ~400px) */
                    rootBox: 'w-full max-w-full min-w-0',
                    cardBox: 'w-full max-w-full min-w-0 shadow-none border-0 bg-transparent',
                    /* Carte externe (page.jsx) — tout le flux sur le même fond */
                    ...
                    headerTitle:
                        'text-white font-bold text-xl tracking-tight !text-center !mx-auto w-full max-w-full',
                    /* Évite le doublon « …vers Trouvable » (déjà le logo au-dessus) */
                    ...
                    /* Colonne : badge au-dessus, puis ligne Google (évite le chevauchement) */
