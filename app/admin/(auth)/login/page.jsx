    ...
    return (
        <div className="min-h-screen bg-slate-100 flex flex-col items-center justify-center p-4">
            <div className="bg-white p-10 rounded-3xl shadow-2xl border border-slate-100 w-full max-w-md flex flex-col items-center relative overflow-hidden">
                ...
                <div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-orange-600 to-pink-600" />

                <div className="w-20 h-20 bg-gradient-to-br from-orange-600 to-pink-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg rotate-3">
